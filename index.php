...
<div class="main__block">
    <div class="main__block__container">
        <div class="box"> 
            ...
            <ul class="list">
                <li><a href="/about us.html" target="_blank">Про нас</a></li>
                <li><a class="scroll" href="#team">Наша команда</a></li>
                <li><a href="/form.php" target="_blank">Контактна форма</a></li>
                <!--
                <li><a href="/sign up.html" target="_blank">Реєстрація</a></li>
                <li><a href="">Війти</a></li>-->
            </ul>   
        </div>
        <div class="ttb">
            <div class="title">for the future</div>
...
<div class="partners">
    ...
    <div class="partners__container">
        <div class="partners__container__first">
            <svg class="icon1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" version="1.1" id="Layer_1" x="0px" y="0px" viewBox="0 0 708.7 357.2" style="enable-background:new 0 0 708.7 357.2;" xml:space="preserve">
                <g>
            ...
            <svg class="icon2" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" version="1.1" id="Layer_1" x="0px" y="0px" viewBox="0 0 708.7 357.2" style="enable-background:new 0 0 708.7 357.2;" xml:space="preserve">
                <style type="text/css">
                    .st0{fill:#1B1C20;}
                </style>
                <g>
            ...
            <svg class="icon4" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" version="1.1" id="Layer_1" x="0px" y="0px" viewBox="0 0 708.7 357.2" style="enable-background:new 0 0 708.7 357.2;" xml:space="preserve">
                <style type="text/css">
                    .st0{fill:#1B1C20;}
                </style>
                <g>
            ...
            <svg class="icon5" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" version="1.1" id="Layer_1" x="0px" y="0px" viewBox="0 0 708.7 357.2" style="enable-background:new 0 0 708.7 357.2;" xml:space="preserve">
                <style type="text/css">
                    .st0{fill:#1B1C20;}
                </style>
...
<div class="contact">
    <div class="block__contact">
        ...
        <a href="/form.php" target="_blank"><input class="btn" type="button" value="Передзвоніть мені"></a>
    </div>
</div>
<footer>
